...
# dalje pokazuje postelavanje ESLint-a u termu nakon instalacije a sa comandom
#? eslint --init    
# pogledao i nemam instaliran ESLint - kad bude aktualno vise cemo se s tim pozabaviti