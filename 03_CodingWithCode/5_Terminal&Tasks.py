...
# sad poslije run task imam u izborniku echo-task, klikam ga i biram opcij "continue without scanning" i u terminalu se odradjuje task echo (ispisuje se Helo!)
