...
# Ath jos istice vaznost odvajanja systemskih fajlova ili "enva" od projekta (instalirao u mapu projekta npm-modul i dobio novih 2K nestage-ani fajlova) i njihovog izuzeca kroz fajl ".gitignore". Kod Ath se automatski pojavilo upozorenje i prijedlog da se ta mapa nastala instalacijom npm-a smjesti u .gitignore
